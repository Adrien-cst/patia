...
def make_move(current_state : State, direction : Move, dimension : int) -> State | None:
    ...
    if current_state:
        ...
        if direction == UP and i >= dimension:
            swap_index = i - dimension
        elif direction == DOWN and i < dimension**2 - dimension:
            swap_index = i + dimension
        elif direction == LEFT and i%dimension != 0:
            swap_index = i - 1
        elif direction == RIGHT and i%dimension != dimension-1:
            swap_index = i + 1
        ...
        new_state[i], new_state[swap_index] = new_state[swap_index], new_state[i]
